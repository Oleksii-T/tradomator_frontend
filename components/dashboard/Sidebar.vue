<template>
  <aside
    id="sidebar"
    class="pt-[71px] fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full font-normal duration-75 lg:flex transition-width"
    aria-label="Sidebar"
  >
    <div
        ...
        <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
          <ul class="pb-2 space-y-2">
            <li>
              ...
              >
                <img class="w-6 h-6" src="~/assets/images/icons/pie-chart.svg" />
          ...
          <div class="pt-2 space-y-2">
            ...
            >
              <img class="w-6 h-6" src="~/assets/images/icons/cog.svg" />
