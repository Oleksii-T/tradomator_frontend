  ...
  <footer>
    ...
    >
      <ul class="flex flex-wrap items-center mb-6 space-y-1 md:mb-0">
        <li>
          <a href="#" class="mr-4 text-sm font-normal text-gray-500 hover:underline md:mr-6 dark:text-gray-400"
    ...
    <p class="my-6 text-sm text-center text-gray-500">
      © 2024 <a href="https://tradomator.com/" class="hover:underline" target="_blank">tradomator.com</a>. All rights
      reserved.
    </p>
  </footer>
</template>
